...
Only the latest published version of `coolhand-cli` on npm is supported with security fixes.
...
- [GitHub Security Advisories](https://github.com/Coolhand-Labs/coolhand-cli/security/advisories/new)
